    ...
    <div>
        ...
        <div className='flex justify-center items-center pb-10'>
            <div className='rounded-2xl shadow-2xl px-10 w-1/4 drop-shadow-2xl  mr-14'>
                <img src='/images/job-card.png' className='w-14 bg-purple-500 p-2 rounded-md -mt-10'/>
            ...
            <div className='rounded-2xl shadow-2xl px-10 w-1/4 drop-shadow-2xl mr-14'>
                <img src='/images/job-merch.png' className='w-14 bg-orange-400 p-2 rounded-md -mt-10'/>
            ...
            <div className='rounded-2xl shadow-2xl px-10 w-1/4 drop-shadow-2xl mr-14'>
                <img src='/images/job-helmet.png' className='w-14 bg-green-500 p-2 rounded-md -mt-10'/>
