  ...
  return (
    <div className='flex w-full -mt-40 justify-center'>
        <div className='w-96 h-80 rounded-[50px] bg-hitam-light relative px-16 py-5 text-white mx-2'>
            <img src='https://rfun-dev.github.io/gojak/images/job-card.png' className='w-24 h-24 bg-hijau-light p-3 rounded-xl absolute -top-8'/>
        ...
        <div className='w-96 h-80 rounded-[50px] bg-hitam-light relative px-16 py-5 text-white mx-2'>
            <img src='https://rfun-dev.github.io/gojak/images/job-helmet.png' className='w-24 h-24 bg-orange-light p-3 rounded-xl absolute -top-8'/>
        ...
        <div className='w-96 h-80 rounded-[50px] bg-hitam-light relative px-16 py-5 text-white mx-2'>
            <img src='https://rfun-dev.github.io/gojak/images/job-merch.png' className='w-24 h-24 bg-purple-light p-3 rounded-xl absolute -top-8'/>
