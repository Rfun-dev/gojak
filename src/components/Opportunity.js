  ...
  return (
    <div className="flex items-center justify-center">
      <div className="m-10 -mt-16 w-52 flex flex-col items-center item-center">
        <img src="https://rfun-dev.github.io/gojak/images/oppur-star.png" alt="oppur" className="w-24 h-24 animate-bounce"/>
      ...
      <div className="m-10 -mt-16 w-52 flex flex-col items-center item-center ">
        <img src="https://rfun-dev.github.io/gojak/images/oppur-money.png" alt="oppur" className="w-24 h-24 animate-bounce"/>
      ...
      <div className="m-10 -mt-16 w-52 flex flex-col items-center item-center">
        <img src="https://rfun-dev.github.io/gojak/images/oppur-greener.png" alt="oppur" className="w-24 h-24 animate-bounce"/>
      ...
      <div className="m-10 -mt-16 w-52 flex flex-col items-center item-center">
        <img src="https://rfun-dev.github.io/gojak/images/oppur-chart.png" alt="oppur" className="w-24 h-24 animate-bounce"/>
